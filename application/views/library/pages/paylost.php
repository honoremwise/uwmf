    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
          <div class="">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Pay Lost book</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="row">
                  ...
                  <table width="100%" class="table table-striped table-hover">
                    ...
                    <tbody>
                      ...
                      foreach ($payrecord as $key) {
                        ...
                        <td>
                          <form action="<?php echo site_url(); ?>Library/paylost" method="post">
                            <input type="hidden" name="bookcode" value="<?php echo $key->book_code; ?>">
                            <input type="hidden" name="studentnumber" value="<?php echo $key->registration_no; ?>">
                            <input type="hidden" name="pricename" value="<?php echo $key->book_price; ?>">
                            <input type="hidden" name="currencytype" value="<?php echo $key->currency_type; ?>">
                            <button type="submit" name="paylost" class="btn btn-outline btn-info fa fa-check" title="pay"></button>
                          </form>
                        </td>
                        <?php
                      }
