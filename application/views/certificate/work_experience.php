      ...
      <div style="color:red; padding-bottom:10px;">
        ...
        ?>
			...
			<div class="row jumbotron-content">
				<form name="userchurchexperience" action="<?php echo base_url();?>index.php/Crt_dpl_experience/" method="post" id="userchurchexperience">
					<div class="form-group col-xs-10 col-sm-10 col-md-12 col-lg-12">
						...
						<input type="text" name="candidatedenomination" class="form-control" value="<?php echo $churches['denomination'];?>" id="candidatedenomination">
					</div>
					<div class="form-group col-xs-10 col-sm-10 col-md-12 col-lg-12">
						<label for="churchname">Name of the Church</label><span id="error_church"></span>
						<input type="text" name="candidatechurch" class="form-control" value="<?php echo $churches['church_name']; ?>" id="candidatechurch">
					</div>
					<div class="form-group col-xs-10 col-sm-10 col-md-12 col-lg-12">
						<label for="address">Address</label><span id="error_churchaddress"></span>
						<input type="text" name="churchaddress" class="form-control" value="<?php echo $churches['church_address']; ?>" id="churchaddress">
					</div>

					<div class="form-group col-xs-10 col-sm-10 col-md-12 col-lg-12">
						<label for="Telephone">Phone</label><span id="error_churchphone"></span>
						<input type="number" name="contactPhone" class="form-control" value="<?php echo $churches['church_phone']; ?>" id="contactPhone">
					</div>
					<div class="clearfix"></div>
					<div class="form-group col-xs-10 col-sm-10 col-md-12 col-lg-12">
						<label for="pastor">Names of the Pastor</label><span id="error_pastor"></span>
						<input type="text" name="pastorName" class="form-control" value="<?php echo $churches['church_pastor']; ?>" id="pastorName">
					</div>
					<div class="clearfix"></div>
          ...
          <div class="form-group col-xs-10 col-sm-10 col-md-12 col-lg-12">
            ...
            <input type="text" name="experiencechurch" class="form-control" value="<?php echo $churches['otherwork_cmp']; ?>" id="experiencechurch">
          </div>
          <div class="form-group col-xs-10 col-sm-10 col-md-12 col-lg-12">
            <label for="position">Position Held</label><span id="error_churchposition"></span>
            <input type="text" name="churchposition" class="form-control" value="<?php echo $churches['otherwork_position']; ?>" id="churchposition">
          </div>
          <div class="form-group col-xs-10 col-sm-10 col-md-12 col-lg-12">
            <label for="startDate">Start Date</label><span id="error_positiondate"></span>
            <input type="text" name="startdate" class="form-control" placeholder="yyyy-mm-dd" value="<?php echo $churches['otherwork_startdate'];?>" id="startdate">
          </div>
          <div class="form-group col-xs-10 col-sm-10 col-md-12 col-lg-12">
            <label for="province">State/Province</label><span id="error_churchprovince"></span>
            <input type="text" name="statelocation" class="form-control" value="<?php echo $churches['otherwork_province']; ?>" id="statelocation">
          </div>
          <div class="form-group col-xs-10 col-sm-10 col-md-12 col-lg-12">
            <label for="district">City/District</label><span id="error_churchdistrict"></span>
            <input type="text" name="citylocation" class="form-control" value="<?php echo $churches['otherwork_district']; ?>" id="citylocation">
          </div>
					<div class="form-group col-xs-10 col-sm-10 col-md-12 col-lg-12">
						<label for="">Responsibities</label>
						<textarea name="workactivities" rows="4" cols="80" class="form-control" placeholder="Write main Responsibities in Church Position" id="workactivities">
						</textarea>
					</div>
					<!-- submit button -->
					<div class="clearfix"></div>
					...
					<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
						<a href="<?php echo base_url();?>save_step?workapplication" id="workcertificate"class="btn btn-outline btn-primary pull-left">Go Next</a>
					</div>
				</form>
			</div>
		</div>
