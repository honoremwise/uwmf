                  ...
                  <ul class="nav navbar-top-links navbar-right">
                      <li class="dropdown">
                          ...
                          <ul class="dropdown-menu dropdown-user">
                              ...
                              <li class="divider"></li>
                              <li><a href="<?php echo base_url();?>index.php/Adminuser/logout"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                              </li>
                          </ul>
                      </li>
                  </ul>
                          ...
                          <div id="collapseOne" class="panel-collapse collapse in">
                              <div class="panel-body">
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li><a href="#useresponsability" data-toggle="tab">User Positions</a>
                                        </li>
                                      </ul>
                                      <div class="tab-content">
                                                        ...
                                                        <thead>
                                                          ...
                                                          <tbody>
                                                            ...
                                                            foreach ($users as $value) {
                                                              ...
                                                              ?>
                                                              <td>
                                                                <form class="" action="<?php echo base_url();?>index.php/Adminuser/statusblock" method="post">
                                        ...
                                        <div class="tab-pane fade" id="useresponsability">
                                          <h4>Define a new system user position</h4>
                                          <form action="<?php echo base_url();?>index.php/adminuser/addUser" method="post">
                                            <div class="form-group">
                                              <label for="position">Position</label>
                                              <input type="text" name="positiontype" id="positiontype" class="form-control" required>
                                            </div>
                                            <input type="submit" name="addUsertype" value="Save" class="btn btn-primary">
                                          </form>
                                        </div>
                                      </div>
                                        ...
                                        <div class="modal-dialog">
                                          ...
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                              <form class="" action="<?php echo base_url();?>index.php/adminuser/addUserdata" method="post">
                                                <div class="form-group">
                                      ...
                                      <div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="addfiletitle" aria-hidden="true" id="addfiletitle">
                                        <div class="modal-dialog">
                                          ...
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                              <form class="" action="<?php echo base_url();?>index.php/adminuser/addfiledata" method="post">
                                                <div class="form-group">
                                                  <label for="telephone">File title</label>
                                                  <input type="text" name="userfileid" value="" id="userfileid" class="form-control" required>
                                                </div>

                                                <input type="submit" name="addfile" value="Save" name="addfile" class="btn btn-primary">
                                              </form>
                                            </div>
                                            <div class="modal-footer">
                                              <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                      ...
                                      <div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="editemail" aria-hidden="true" id="editemail">
                                        <div class="modal-dialog">
                                          ...
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                              <form class="" action="<?php echo base_url();?>index.php/adminuser/changeuser" method="post">
                                                <div class="form-group">
                                                ...
                                                <input type="submit" name="addemail" value="Update" name="addemail" class="btn btn-primary">
                                              </form>
                                            </div>
                                            <div class="modal-footer">
                                              <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                      ...
                                      <div class="modal fade" tabindex="-1" aria-labelledby="addfile" role="modal" aria-hidden="true" id="addfile">
                            						<div class="modal-dialog">
                            							<div class="modal-content">
                            								...
                            								<div class="modal-body">
                                              <form action="<?php echo base_url(); ?>index.php/adminuser/uploads" method="post" enctype="multipart/form-data">
                                                <h5>Upload a file</h5>
                                                <div class="form-group">
                                                  <label for=""></label>
                                     ...
                                     <div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="addschedule" aria-hidden="true" id="addschedule">
                                       <div class="modal-dialog">
                                         <div class="modal-content">
                                           ...
                                           <div class="modal-body">
                                             <form class="" action="<?php echo base_url(); ?>index.php/Adminuser/updatedate" method="post">
                                               <div class="form-group">
                                               ...
                                               <input type="submit" name="savedate" value="Update" class="btn btn-primary">
                                             </form>
                                           </div>
                                           <div class="modal-footer">
                                             <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
