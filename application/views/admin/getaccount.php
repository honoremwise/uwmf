        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                  <center>
                    ...
                    <div class="panel-body" style="color: red;">
                        ...
                        <?php echo form_open('Adminuser/create'); ?>
                        <form role="form" method="post">
                            <fieldset>
                                ...
                                <input type="submit" name="registerlogin" class="btn btn-lg btn-primary btn-block" value="Choose Password">
                            </fieldset>
                        </form>
                ...
                <?php if (isset($created)) {
                  ?>
                  Account created&nbsp;&nbsp;<a href="<?php echo base_url()?>index.php/Users" class="btn btn-link">Login Here</a>
                  <?php
                } ?>
            </div>
        </div>
