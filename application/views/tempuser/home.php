                ...
                <div class="login-panel panel panel-default">
                  <center>
                    ...
                    <div class="panel-body" style="color: red;">
                        ...
                        <?php echo form_open('tempuserLogin/account'); ?>
                        ...
                        <form role="form" method="post">
                            ...
                            <center><a href="<?php echo base_url()?>index.php/Getreset"><span style="font-size: 13px;font-weight: 700;">Password Help</span></a></center><hr>
                        </form>
