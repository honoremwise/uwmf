 ...
 if(isset($_GET['reject1'])){
  ...
  echo"<div class='alert alert-info alert-dismissable'>
                      ...
                      <div class="panel panel-primary">
                              ...
                              <div class="panel-body">
                                    ...
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li><a href="#Masters-pills" data-toggle="tab">Masters Applicants </a>
                                        </li>
   ...
   <?php                                              
    ...
    $dbbranches=mysqli_query($db,"select * from candidates join applications USING(reference_no) where applications.program_code='04' and applications.application_status='pending'") or die(mysqli_error($db));
